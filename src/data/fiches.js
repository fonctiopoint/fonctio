    ...
    fiches: [
      {
        ...
        droits: [
          ...
          { label: 'Primes en FPH', valeur: 'Selon chaque prime', detail: 'En FPH, il n\'existe pas de règle nationale qui aligne les primes sur le traitement — contrairement à l\'État. Chaque prime suit son propre texte.\n\nExemple : la prime de service perd un cent-quarantième de son montant par jour d\'absence. Elle est maintenue pendant l\'accident de service, la maladie professionnelle, le congé annuel et la maternité — pas pendant le congé de maladie ordinaire.\n\nDemandez à votre DRH le détail prime par prime plutôt qu\'un pourcentage global. Source : décret 68-929 du 24 octobre 1968.', versants: ['fph'] },
          ...
          { label: 'Jour de carence', valeur: '1er jour', detail: 'Le premier jour de chaque arrêt n\'est pas rémunéré. Il ne s\'applique pas dans ces cas :\n• congé de longue maladie, de longue durée ou de grave maladie\n• accident de service et maladie professionnelle\n• congé accordé dans les trois ans qui suivent un premier congé pour la même affection de longue durée\n• congé de maternité, état pathologique lié à la grossesse et arrêts après la déclaration de grossesse\n• premier arrêt dans les treize semaines qui suivent le décès d\'un enfant\n• second arrêt pour la même cause, si la reprise entre les deux n\'a pas dépassé 48 heures (les deux conditions sont alors nécessaires)\n\nSource : art. 115 de la loi 2017-1837.' },
        ...
        etapes: [
          ...
          { num: 3, titre: 'Durée plafonnée', texte: 'Pour les arrêts prescrits depuis le 1er septembre 2026, un premier avis d\'arrêt ne peut excéder 31 jours et une prolongation 62 jours. Deux choses à savoir. Le plafond porte sur chaque avis, pas sur la durée totale de votre arrêt : il impose de repasser voir un médecin, il ne raccourcit pas vos droits. Et il peut être dépassé — le prescripteur initial, votre médecin traitant, la sage-femme ou le chirurgien-dentiste peuvent aller au-delà en justifiant sur la prescription la nécessité d\'une durée plus longue au regard de votre situation. Sources : art. R. 162-1-7-1 du code de la sécurité sociale (décret 2026-498) et art. L. 162-4-4 du même code.' },
          { num: 4, titre: 'Prolongation par le même médecin', texte: 'La prolongation doit en principe émaner du prescripteur initial, de votre médecin traitant, de la sage-femme ou du chirurgien-dentiste.\n\nTrois cas donnent quand même lieu à indemnisation :\n• la prolongation prescrite par un médecin spécialiste consulté à la demande de votre médecin traitant\n• celle prescrite par le médecin qui remplace le prescripteur initial ou le médecin traitant\n• celle prescrite à l\'occasion d\'une hospitalisation\n\nEn dehors de ces trois cas, vous devez justifier de l\'impossibilité pour l\'un ou l\'autre de prolonger, par tous moyens si la caisse le demande. Dans tous les cas, le motif doit être porté sur l\'avis d\'arrêt. Sources : art. L. 162-4-4 et R. 162-1-9-1 du code de la sécurité sociale.' },
        ...
        pieges: [
          ...
          'Faites établir vos prolongations par le médecin qui a prescrit l\'arrêt initial, ou par votre médecin traitant.\n\nSi ce n\'est pas possible, trois situations donnent quand même lieu à indemnisation, sans autre justification :\n• le spécialiste consulté à la demande de votre médecin traitant\n• le médecin remplaçant de l\'un des deux\n• la prolongation prescrite à l\'occasion d\'une hospitalisation\n\nDans les autres cas, faites porter sur l\'avis le motif pour lequel ce n\'est ni l\'un ni l\'autre qui prolonge — c\'est cette mention qui protège votre rémunération. Source : art. R. 162-1-9-1 du code de la sécurité sociale.',
          ...
          'Le congé d\'office obéit à une procédure précise :\n• examen par un médecin agréé\n• saisine obligatoire du conseil médical avant tout placement d\'office en CLM\n• notification écrite portant les voies et délais de recours\n• possibilité pour vous de présenter vos observations avant que la décision soit prise',
          'Ne confondez pas le congé d\'office avec la mise en disponibilité d\'office : le congé d\'office maintient vos droits à rémunération, la disponibilité les suspend.',
        ],
      ...
      },
      {
        ...
        versantNotes: {
          fpe: 'FPE : depuis le 11 novembre 2021, le TPT peut être accordé sans condition préalable d\'arrêt de travail. Source : Décret 2021-997.',
          fpt: 'FPT : aucun arrêt de travail préalable n\'est exigé depuis le 11 novembre 2021, ni pour les agents affiliés à la CNRACL ni pour ceux affiliés à l\'IRCANTEC. Le temps partiel thérapeutique se demande directement, sur certificat du médecin traitant, sans avoir été en congé de maladie auparavant. Source : Décret 2021-1462.',
          fph: 'FPH : le temps partiel thérapeutique est organisé par le Décret 2021-996 du 28 juillet 2021, qui a lui aussi supprimé la condition d\'arrêt de travail préalable.',
        },
      },
      {
        ...
        etapes: [
          ...
          { num: 5, titre: 'Fin de disponibilité', texte: 'Au plus tard au terme de la durée maximale applicable à votre versant — trois ans (quatre si un dernier renouvellement a été accordé) en FPT et en FPH, six ans (sept si un dernier renouvellement a été accordé) en FPE depuis le décret 2024-1222 — votre situation doit être tranchée :\n• reprise du service si vous êtes reconnu apte\n• reclassement dans un autre emploi adapté\n• mise à la retraite pour invalidité si l\'inaptitude est définitive\n• licenciement, si vous n\'avez pas droit à pension\n\nL\'administration doit vous avoir invité à présenter une demande de reclassement avant d\'en arriver là.' },
        ],
        pieges: [
      ...
      },
      {
        ...
        droits: [
          { label: 'Temps partiel de droit', valeur: 'Incontournable, jusqu\'à 80 %', detail: 'Quatre motifs ouvrent le droit, à une quotité de 50, 60, 70 ou 80 % :\n• chaque naissance, jusqu\'aux 3 ans de l\'enfant\n• une adoption, 3 ans à compter de l\'arrivée au foyer\n• les soins à donner à un conjoint, un partenaire de PACS, un enfant à charge ou un ascendant victime d\'un handicap nécessitant la présence d\'un tiers, d\'un accident ou d\'une maladie grave\n• le handicap de l\'agent lui-même, sur avis du médecin du travail\n\nL\'administration ne peut pas le refuser. Le palier à 90 % n\'existe pas en temps partiel de droit. Source : art. L. 612-3 du CGFP.' },
    ...
    fiches: [
      {
        ...
        etapes: [
          ...
          { num: 6, titre: 'Période de préparation au reclassement', texte: 'Un an à plein traitement pour construire votre reclassement (voir le droit ci-dessus — demandez-le sans attendre) : formation, bilan de compétences, recherche de poste dans votre administration d\'origine ou ailleurs.' },
      ...
      },
      {
        ...
        etapes: [
          ...
          { num: 2, titre: 'Période de préparation au reclassement', texte: 'Un projet de reclassement est établi avec l\'administration : formations, stages, périodes d\'observation, pendant la durée de la PPR (voir le droit ci-dessus).' },
      ...
      },
      {
        ...
        droits: [
          ...
          { label: 'Durée', valeur: '5 ans, puis définitive', detail: 'La majoration est accordée pour cinq ans — voir « La démarche » pour ce qui se passe à l\'issue de cette période. Ce n\'est pas un renouvellement à durée limitée qui se répéterait indéfiniment. Sources : art. R. 38 du code des pensions civiles, CNRACL.' },
        ],
        etapes: [
...
// ─────────────────────────────────────────────────────────────────────────────
    ...
    fiches: [
      ...
      },
      {
        ...
        pieges: [
          ...
          'Les agents contractuels ont accès aux prestations d\'action sociale dans les mêmes conditions que les titulaires — la distinction titulaire/contractuel ne justifie pas un refus. L\'article L. 731-3 du CGFP est explicite : ces prestations sont attribuées indépendamment du grade, de l\'emploi et de la manière de servir.',
        ],
        ...
        sources: [
          ...
          { texte: 'Art. L. 731-2 CGFP (les agents participent à la définition et à la gestion de l\'action sociale dont ils bénéficient)' },
          { texte: 'Art. L. 731-3 CGFP (les prestations sont distinctes de la rémunération et attribuées indépendamment du grade, de l\'emploi et de la manière de servir)' },
    ...
    fiches: [
      {
        ...
        droits: [
          ...
          { label: 'Ce qui arrive en prévoyance', valeur: '50 % au plus tard en 2029', detail: 'La loi n° 2025-1251 du 22 décembre 2025 transpose l\'accord national du 11 juillet 2023 : la prévoyance devra relever d\'un contrat collectif, la participation employeur passera à au moins 50 % des cotisations, et aucune couverture ne pourra être refusée au titre d\'antécédents médicaux. Le 1er janvier 2029 est la date butoir pour les collectivités qui n\'ont encore aucun accord de participation : celles qui en ont déjà un basculent à la fin de cet accord, ce qui peut être plus tôt. Demandez à votre DRH la date qui s\'applique à votre collectivité. D\'ici là, la règle des 20 % de 35 € reste celle qui s\'applique.', versants: ['fpt'] },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    count: 3,
    versants: ['fpe', 'fpt', 'fph'],
    description: 'Entretien professionnel, congé de formation professionnelle, supplément familial de traitement',
    fiches: [
      {
        id: 'evaluation',
      ...
      {
        id: 'sft',
        titre: 'Supplément familial de traitement (SFT)',
        categorie: 'Carrière & formation',
        chips: ['Tous agents', 'Enfants à charge', 'Fixe + %', 'Un seul droit par enfant'],
        resume: 'Le SFT est versé à tout agent public — titulaire ou contractuel — ayant au moins un enfant à charge. Son montant combine un élément fixe et, à partir de deux enfants, un élément proportionnel au traitement. Un seul droit est ouvert par enfant, quel que soit le nombre de parents agents publics.',
        ciblePublic: 'Agents publics titulaires et contractuels des trois versants ayant au moins un enfant à charge, dès lors que leur rémunération est fixée par référence au traitement des fonctionnaires ou évolue comme lui. Exclus : les agents rétribués au taux horaire ou à la vacation.',
        droits: [
          { label: 'Qui peut en bénéficier', valeur: 'Titulaires et contractuels', detail: 'Le droit est ouvert aux fonctionnaires, aux magistrats, aux militaires à solde mensuelle et à tout agent — contractuel compris — dont la rémunération est fixée par référence aux traitements des fonctionnaires ou évolue comme eux. En sont exclus les agents rétribués au taux horaire ou à la vacation. Un seul droit est ouvert par enfant. Sources : art. L. 712-8 CGFP, art. 10 du décret 85-1148.' },
          { label: 'Un enfant', valeur: '2,29 € fixe', detail: 'Aucun élément proportionnel pour un seul enfant : c\'est le seul cas où le SFT ne dépend pas du traitement. Source : art. 10 bis du décret 85-1148, en vigueur depuis le 1er janvier 2024.' },
          { label: 'Deux enfants', valeur: '10,67 € + 3 % du traitement', detail: 'L\'élément proportionnel s\'ajoute à partir du deuxième enfant, en plus de l\'élément fixe.' },
          { label: 'Trois enfants', valeur: '15,24 € + 8 % du traitement', detail: 'La part fixe et le pourcentage augmentent ensemble à chaque enfant supplémentaire, jusqu\'au troisième.' },
          { label: 'Par enfant au-delà du 3e', valeur: '+ 4,57 € + 6 % du traitement', detail: 'Ce montant s\'ajoute pour chaque enfant à charge supplémentaire au-delà du troisième — il ne remplace pas les tranches précédentes, il s\'y cumule.' },
          { label: 'Base du pourcentage', valeur: 'Entre les indices bruts 524 et 879', detail: 'L\'élément proportionnel se calcule sur le traitement soumis à retenue pour pension, dans la limite du traitement afférent à l\'indice brut 879 : au-delà, le supplément de traitement n\'augmente plus le SFT. À l\'inverse, un agent dont l\'indice est inférieur ou égal à l\'indice brut 524 perçoit le SFT calculé sur cet indice, jamais moins. Pour les agents dont la rémunération n\'est pas indiciaire, le pourcentage se calcule directement sur le traitement afférent à l\'indice brut 524.' },
          { label: 'Enfant à charge', valeur: 'Jusqu\'à 20 ans, sous condition', detail: 'La notion retenue est celle des prestations familiales : l\'enfant ouvre droit jusqu\'à son vingtième anniversaire, à condition que sa rémunération éventuelle ne dépasse pas 55 % du SMIC mensuel. Source : art. R. 512-2 du code de la sécurité sociale.' },
          { label: 'Couple d\'agents publics', valeur: 'Un seul bénéficiaire désigné', detail: 'Quand les deux parents assument la charge des mêmes enfants, ils désignent d\'un commun accord celui qui perçoit le SFT. Ce choix peut être changé à tout moment, mais ne peut être remis en cause qu\'au bout d\'un an, sauf changement de situation. Sources : art. L. 712-9 CGFP, art. 10 du décret 85-1148.' },
          { label: 'Résidence alternée', valeur: 'Partage possible par moitié', detail: 'La charge de l\'enfant peut être partagée à parts égales entre les deux parents, sur demande conjointe ou lorsqu\'ils sont en désaccord sur la désignation du bénéficiaire unique. Chaque enfant en résidence alternée compte alors pour une demi-part dans le calcul. Un partage choisi d\'un commun accord ne peut être remis en cause qu\'au bout d\'un an, sauf changement du mode de résidence. Sources : art. L. 712-10 CGFP, art. 11 bis et 11 ter du décret 85-1148.' },
          { label: 'Divorce ou séparation', valeur: 'Choix du parent de référence', detail: 'Chaque bénéficiaire peut demander que son SFT soit calculé de son propre chef, ou du chef de son ex-conjoint si celui-ci est aussi agent public — au prorata du nombre d\'enfants à la charge de chacun, et sur la base de l\'indice du parent de référence choisi. Source : art. 11 du décret 85-1148.' },
          { label: 'Temps partiel', valeur: 'Proratisé, sauf pour un enfant', detail: 'Le SFT suit la quotité de traitement soumise à retenue pour pension — sauf l\'élément fixe prévu pour un enfant (2,29 €), qui reste entier quelle que soit la quotité travaillée. Source : art. 12 du décret 85-1148.' },
        ],
        tableau: {
          colonnes: [
            { label: 'Enfants à charge', flex: 1.3 },
            { label: 'Élément fixe', flex: 1 },
            { label: 'Élément %', flex: 0.9 },
          ],
          lignes: [
            ['1 enfant', '2,29 €', '—'],
            ['2 enfants', '10,67 €', '3 %'],
        ...
        etapes: [
          { num: 1, titre: 'Déclarer l\'enfant au service RH', texte: 'Transmettre l\'acte de naissance ou de reconnaissance, ou le jugement d\'adoption, dès que possible. Le SFT n\'est jamais rétroactif au-delà des règles d\'ouverture de droit fixées pour les prestations familiales.' },
          { num: 2, titre: 'Désigner le bénéficiaire, si besoin', texte: 'Si les deux parents sont agents publics, ils indiquent d\'un commun accord lequel des deux perçoit le SFT. En cas de résidence alternée, préciser dès cette étape si un partage à parts égales est demandé.' },
          { num: 3, titre: 'Signaler tout changement de situation', texte: 'Séparation, passage en résidence alternée, enfant qui atteint 20 ans ou dépasse le plafond de ressources, arrivée d\'un nouvel enfant : chaque changement modifie le montant ou l\'ouverture du droit et doit être signalé sans attendre.' },
          { num: 4, titre: 'Vérifier sa fiche de paie', texte: 'Le SFT apparaît comme une ligne distincte du traitement. Contrôler que le nombre d\'enfants retenu correspond à la situation réelle, surtout après un changement récent.' },
        ],
        pieges: [
          'Pour un seul enfant, le SFT est un montant fixe de 2,29 € qui ne suit pas le traitement — contrairement aux tranches à partir de deux enfants, il ne bouge pas si l\'indice change.',
          'Le SFT ne se cumule pas avec un avantage de même nature versé pour le même enfant par un autre employeur public, ou par un établissement public à caractère industriel et commercial, une entreprise publique ou un organisme majoritairement financé par des fonds publics. Cette interdiction ne vise pas le secteur privé : un supplément familial versé par l\'employeur privé du conjoint peut se cumuler avec le SFT. Source : art. L. 712-11 CGFP.',
          'En cas de résidence alternée, le partage à parts égales n\'est pas automatique : il suppose une demande conjointe des parents, ou intervient si l\'administration constate un désaccord sur le bénéficiaire unique.',
          'Un seul droit est ouvert par enfant, même si les deux parents sont agents publics : ce n\'est pas un cumul entre les deux, seulement le choix de celui dont l\'indice servira de base au calcul.',
        ],
        recours: 'Contestation du montant ou refus d\'ouverture du droit : recours gracieux auprès du service RH ou de l\'administration, puis tribunal administratif.',
        sources: [
          { texte: 'Art. L. 712-8 à L. 712-11 CGFP (droit au SFT, désignation du bénéficiaire, résidence alternée, non-cumul)', url: 'https://www.legifrance.gouv.fr/codes/section_lc/LEGITEXT000044416551/LEGISCTA000044423779/' },
          { texte: 'Décret n° 85-1148 du 24 octobre 1985, art. 10, 10 bis, 11, 11 bis, 11 ter et 12 (barème, calcul et cas particuliers)', url: 'https://www.legifrance.gouv.fr/codes/section_lc/JORFTEXT000000872483/LEGISCTA000006091910/' },
          { texte: 'Décret n° 2023-519 du 28 juin 2023 (barème en vigueur depuis le 1er janvier 2024)' },
          { texte: 'Décret n° 2020-1366 du 10 novembre 2020 (partage en cas de résidence alternée)' },
          { texte: 'Art. R. 512-2 du code de la sécurité sociale (enfant à charge : jusqu\'à 20 ans, sous plafond de ressources)' },
          { texte: 'Circulaire du 9 août 1999 relative aux modalités de calcul et de versement du SFT' },
          { texte: 'Portail de la fonction publique — Le supplément familial de traitement (SFT)', url: 'https://www.fonction-publique.gouv.fr/etre-agent-public/ma-remuneration/le-traitement-indiciaire-brut/le-supplement-familial-de-traitement-sft' },
        ],
      },
    ],
  },
