    ...
    fiches: [
      ...
      },
      {
        ...
        droits: [
          ...
          { label: 'Si imputable au service', valeur: 'Voir CITIS', detail: 'Lorsque l\'affection était contractée dans l\'exercice des fonctions, le CLD était porté à 5 ans à plein traitement + 3 ans à demi-traitement, soit 8 ans. Attention : ce régime ne vaut plus pour les imputabilités reconnues aujourd\'hui. Le CITIS s\'est substitué au CLD imputable au service (Décret 2019-122 du 21 février 2019 pour la FPE, Décret 2019-301 du 10 avril 2019 à compter du 13 avril 2019 pour la FPT, Décret 2020-566 du 13 mai 2020 à compter du 16 mai 2020 pour la FPH). Le CITIS est plus favorable : plein traitement sans limite de durée et primes maintenues. Les 8 ans ne subsistent que pour les imputabilités reconnues avant ces dates.' },
        ],
        tableau: {
          colonnes: [
            { label: 'Période', flex: 1.2 },
