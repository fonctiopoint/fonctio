    ...
    fiches: [
      {
        ...
        resume: 'L\'assistant de prévention est un agent nommé par l\'autorité administrative pour assister et conseiller le chef de service dans la mise en œuvre des règles d\'hygiène, de sécurité et de prévention des risques professionnels.',
        ...
        droits: [
          ...
          { label: 'Positionnement hiérarchique', valeur: 'Sous l\'autorité du chef de service', detail: 'L\'assistant de prévention intervient sous l\'autorité hiérarchique du chef de service qui l\'a nommé. Il n\'est pas indépendant de la hiérarchie, contrairement au médecin de prévention.' },
        ...
        etapes: [
          { num: 1, titre: 'Nomination', texte: 'L\'assistant de prévention est nommé par l\'autorité administrative (ministre, préfet, directeur d\'établissement…) sur proposition du chef de service. La nomination fait l\'objet d\'un acte formel précisant la quotité de temps et les missions.' },
