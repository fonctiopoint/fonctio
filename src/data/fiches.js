    ...
    fiches: [
      {
        ...
        etapes: [
          ...
          { num: 3, titre: 'Durée plafonnée', texte: 'Pour les arrêts prescrits depuis le 1er septembre 2026, un premier avis d\'arrêt ne peut excéder 31 jours et une prolongation 62 jours. Le plafond porte sur chaque avis, pas sur la durée totale de votre arrêt : si votre état le justifie, le médecin prolonge autant que nécessaire. Ces plafonds ne réduisent donc pas vos droits, ils imposent de repasser voir un médecin plus souvent. Source : art. R. 162-1-7-1 du code de la sécurité sociale.' },
          { num: 4, titre: 'Prolongation par le même médecin', texte: 'La prolongation doit en principe émaner du prescripteur initial, de votre médecin traitant, de la sage-femme ou du chirurgien-dentiste. Trois cas échappent à cette règle sans que vous ayez à vous justifier : la prolongation prescrite par un spécialiste consulté à la demande de votre médecin traitant, celle prescrite par un médecin qui remplace l\'un des deux, et celle prescrite pendant une hospitalisation. En dehors de ces cas, il faut justifier de l\'impossibilité pour le prescripteur initial ou le médecin traitant de prolonger, et le motif doit être porté sur l\'avis d\'arrêt. Source : art. L. 162-4-4 du code de la sécurité sociale.' },
        ...
        pieges: [
          ...
          'Faites établir vos prolongations par le médecin qui a prescrit l\'arrêt initial ou par votre médecin traitant. Si ce n\'est pas possible, sachez que trois situations sont couvertes d\'office : le spécialiste consulté à la demande de votre médecin traitant, le médecin remplaçant, et la prolongation prescrite pendant une hospitalisation. Dans les autres cas, faites porter sur l\'avis le motif pour lequel ce n\'est ni l\'un ni l\'autre qui prolonge — c\'est cette mention qui protège votre rémunération.',
        ...
        sources: [
          ...
          { texte: 'Art. R. 162-1-7-1 du code de la sécurité sociale (31 jours pour un premier avis, 62 pour une prolongation, depuis le 01/09/2026)' },
          { texte: 'Art. L. 162-4-4 du code de la sécurité sociale (qui peut prolonger, et les trois cas couverts d\'office)' },
      ...
      },
      {
        ...
        droits: [
          ...
          { label: 'Portabilité', valeur: 'Le congé vous suit', detail: 'Le fonctionnaire qui a obtenu un congé de longue maladie en conserve le bénéfice auprès de toute personne publique qui l\'emploie. Une mutation, un détachement ou un changement de versant ne remettent donc pas vos droits à zéro, et n\'obligent pas à tout recommencer devant un nouveau conseil médical. Source : art. L. 822-10 du CGFP.' },
        ],
        tableau: null,
        tableaux: {
          fpe: {
